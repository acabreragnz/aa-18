...
class TestKMeans(TestCase):
    ...
    def test(self):
        ...
        # dataset = load_files("../../../datasets/Health-Tweets")
        dataset = load_files ("../../../datasets")
        #dataset = fetch_20newsgroups(subset='all', shuffle=True, random_state=42)
        print(dataset.target_names)
        # list of text documents
        text = dataset.data#["The quick brown fox jumped over the lazy dog."]
    ...
    def test2(self):
        ...
        digits = load_files("../../datasets/Health-Tweets")
        # digits = fetch_20newsgroups(subset='all', shuffle=True, random_state=42)

        count_vect = CountVectorizer (encoding='latin-1')
        data = count_vect.fit_transform(digits.data)

        n_samples, n_features = data.shape
        k_clusters = len (np.unique (digits.target))
