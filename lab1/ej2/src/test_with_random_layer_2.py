...
class TestWithOldVersion(unittest.TestCase):
    ...
    def test_squared_errors1(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu01.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
    ...
    def test_squared_errors2(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu02.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors3(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu03.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors4(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu04.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors5(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu05.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors6(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu06.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors7(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu07.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors8(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu08.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
    ...
    def test_squared_errors9(self):
        ...
        logging.basicConfig(filename='./logs/test_with_random_player_mu09.log', level=logging.INFO)
        logging.info('------------------------------------------------------------------------------------------------')
        logging.info('Started')
